...
CREATE DATABASE cmdb WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'en_US.UTF-8';
...
--
-- Name: cmdb; Type: DATABASE PROPERTIES; Schema: -; Owner: postgres
--

ALTER DATABASE cmdb SET "TimeZone" TO 'Asia/kolkata';
...
GRANT ALL ON DATABASE cmdb TO cm;
GRANT CONNECT ON DATABASE cmdb TO rajesh_ponna;
GRANT CONNECT ON DATABASE cmdb TO metabase;
